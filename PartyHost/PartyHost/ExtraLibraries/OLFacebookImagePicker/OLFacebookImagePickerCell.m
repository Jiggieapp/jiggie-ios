...
- (void)bind:(OLFacebookImage *)media {
    ...
    [self.imageView setAndFadeInFacebookImageWithURL:[media bestURLForSize:CGSizeMake(600, 600)]]; // opted for slightly larger than thumb url. Might be better for performance just to go with thumb.
}
