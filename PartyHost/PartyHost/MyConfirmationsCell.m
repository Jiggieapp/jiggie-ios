...
@implementation MyConfirmationsCell
...
-(void)showNone
{
    self.day.hidden = self.month.hidden = self.imgIcon.hidden = self.subtitle.hidden = self.title.hidden = YES;
    self.textLabel.textAlignment = NSTextAlignmentCenter;
    self.textLabel.text = @"You have no confirmations";
    self.accessoryType = UITableViewCellAccessoryNone;
}
...
-(void)loadData:(NSDictionary *)dict
{
    ...
    self.title.text = [[dict objectForKey:@"event"] objectForKey:@"title"];
    self.subtitle.text = [dict objectForKey:@"description"];
